...
(async function () {
  ...
  // is a live-embedded link to it plus a read-only rendering of the same
  // data the rest of the app already reads.
  async function initScheduleSheetEmbed() {
    ...
    } catch (err) { /* non-fatal - the read-only table below still works */ }
  }
